...
class GenerateOptions():
    ...
    def initialize(self):
        self.parser.add_argument("--opt_path", type=str, default='/data/kuimou/SET/checkpoints/cmp/cmp_base_t5/opt.txt', help='option file path for loading model')
        self.parser.add_argument("--gpu_id", type=int, default=4, help='GPU id')
        ...
        # generate prompts
        self.parser.add_argument('--text_prompt', type=str, default="weapon attack a man holding a Shield,executing a Two-Handed,Light Attack,root motion get Forward, Light-Weighted,Straightforward and Uniform Speed,which make a sense of Smooth and Coherent,Blunt.", help='One text description pompt for motion generation')

        self.parser.add_argument("--motion_length", default=8.0, type=float, help="The length of the generated motion [in seconds] when using prompts. Maximum is 9.8 for HumanML3D (text-to-motion)")
