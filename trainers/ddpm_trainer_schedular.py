...
class DDPMTrainer_schedular(object):
    ...
    def forward(self, batch_data):
        ...
        self.prediction = self.model.forward_with_cfg(x_t, t, text=caption)
    ...
    def train(self, train_loader):
        ...
        for epoch in range(0, num_epochs):
            ...
            for i, batch_data in enumerate(train_loader):
                ...
                if it+1 % self.opt.save_interval == 0 or should_save and self.accelerator.is_main_process: # 500
